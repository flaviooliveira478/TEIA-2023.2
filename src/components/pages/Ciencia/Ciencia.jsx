            ...
            <Link to="../noticias/2">
              ...
              <div className="overlay-text">
                ...
                <p>
                  ...
                  receberam o Nobel de Fisiologia ou Medicina 2023 por suas pesquisas que lançaram as 
                  bases para as vacinas de RNA mensageiro (mRNA) contra a Covid-19. 
                </p>
          ...
          <div className="col-3 col-sm-6 device-square text-overlay">
            <Link to="../noticias/3">
              ...
              <div className="overlay-text">
                ...
                <p>
                  Esperança para pacientes com Alzheimer: Um novo medicamento experimental, o donanemabe,
                  mostrou-se capaz de retardar o declínio cognitivo em até 60% em pacientes nos estágios iniciais
                  da doença.
                </p>
                <p className="lermore">Ler Mais</p>
              </div>
          ...
          <div className="col-3 col-sm-6 device-square text-overlay">
            <Link to="../noticias/5">
              ...
              <div className="overlay-text">
                <h4 className="new-h4">Ciência</h4>
                <h4>
                  Ciência de dados e IA na saúde
                </h4>
                <p>
                  O setor da saúde enfrenta a constante necessidade de otimizar operações e lidar com a 
                  escassez de profissionais qualificados. A ciência de dados e a IA surgem como aliadas 
                  para superar esses desafios, impulsionando a escalabilidade e a eficiência.
                </p>
                <p className="lermore">Ler Mais</p>
              </div>
            </Link>
